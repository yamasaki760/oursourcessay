...
@Component
public class CurrentUserTextWebSocketHandler extends TextWebSocketHandler {

	private static Logger logger = LoggerFactory.getLogger(CurrentUserTextWebSocketHandler.class);
